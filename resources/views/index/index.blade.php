...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            @foreach($listFilm as $listFilm)
            <a href="{{asset('detail-film/'.$listFilm->id.'/'.$listFilm->slug.'.html')}}" class="movie-item">
...
<!--                 <a href="#" class="movie-item">
                ...
                <a href="#" class="movie-item">
                    <img src="./images/movies/poster.jpg" alt="">
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Poster
                        </div>
    ...
    <div class="copyright">
        Copyright 2021 <a href="https://www.youtube.com/channel/UCnNgtK4tGlWcceXVzoyTg8Q" target="_blank">Nguyễn Duy
            Tùng</a>
    </div>
